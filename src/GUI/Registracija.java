...
public class Registracija extends JFrame {
	...
	private JLabel getLblSpol() {
		if (lblSpol == null) {
			lblSpol = new JLabel("Spol:");
			lblSpol.setBounds(240, 11, 46, 14);
			lblSpol.setForeground(Color.GRAY);
			lblSpol.setFont(new Font("Ariel", Font.BOLD, 14));
		}
		return lblSpol;
	}
	...
	private JButton getBtnRegistriraj() {
		if (btnRegistriraj == null) {
			btnRegistriraj = new JButton("Registriraj");
			btnRegistriraj.setBounds(132, 173, 89, 23);
